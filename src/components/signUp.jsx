...
function SignUp()
{
                ...
                <div className="form-holder">
                    ...
                    <div className="form-row">
                        <div className="form-input">
                            ...
                            <div className="form-input-content"><input ref={addInput} type="text" id="firstName" name="user_firstName" maxLength="48" required /><span></span></div>
                            <div className="form-input-error"></div>
                        </div>
                        <div className="form-input">
                            <div className="form-input-label"><label htmlFor="lastName">Last Name</label></div>
                            <div className="form-input-content"><input ref={addInput} type="text" id="lastName" name="user_lastName" maxLength="48" required /><span></span></div>
                            <div className="form-input-error"></div>
                        </div>
                    </div>
                    <div className="form-row">
                        <div className="form-input">
                            ...
                            <div className="form-input-content"><input ref={addInput} type="text" id="userName" name="user_name" minLength="3" maxLength="36" required /><span></span></div>
                            <div className="form-input-error"></div>
                        </div>
                        <div className="form-input">
                    ...
                    <div className="form-row">
                        ...
                        <div className="form-input">
                            ...
                            <div className="form-input-content"><input ref={addInput} type="password" id="confirmPassword" name="user_confirm-password" required minLength="6" maxLength="32" /><span></span></div>
                            <div className="form-input-error"></div>
                        </div>
                    </div>
                    <div className='form-row'>
    ...
    {
        strengthFirstBar.current.style["background-color"] = "#dd160f";
        strengthSecondBar.current.style["background-color"] = "#dd160f";
        strengthThirdBar.current.style["background-color"] = "#dd160f";
        strengthFourthBar.current.style["background-color"] = "#dd160f";
        strengthCaption.current.textContent = "Weak";
        strengthCaption.current.style["color"] = "#dd160f";
    }
